...
namespace AutoHook.Resources.Localization {
    ...
    internal class UIStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Use Nature&apos;s Bounty (Only when Catch Everything is enabled).
        /// </summary>
        internal static string CatchAllNaturesBounty {
            get {
                return ResourceManager.GetString("CatchAllNaturesBounty", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Catch Everything (Ignore Presets).
        /// </summary>
        internal static string CatchEverythingIgnorePresets {
            get {
                return ResourceManager.GetString("CatchEverythingIgnorePresets", resourceCulture);
            }
        }
